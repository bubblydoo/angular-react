...
@Component({
  ...
  template: `
    <div>
      <ng-template [ngTemplateOutlet]="tmpl" [ngTemplateOutletContext]="{ message: message.toUpperCase() }"></ng-template>
    </div>
  `
})
...
@Component({
  template: `
    <div style="border: 1px solid; padding: 5px">
      <react-wrapper [component]="Message" [props]="{ message: 'hello world!' }"></react-wrapper>
    </div>
  `,
})
